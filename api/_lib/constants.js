...
export const BOT_TOKEN = process.env.BOT_TOKEN || '';             // leminhtanbot - báo đơn cho KHÁCH
export const TROLYMT_BOT_TOKEN = process.env.TROLYMT_BOT_TOKEN || ''; // trolymtabot - báo cáo cho OWNER
